...
\NewEnviron{restatabletheorem}[1]{%
  ...
  \expandafter\thm\BODY\unskip\label{#1}\endthm%
}
\newcommand{\restatelemma}[1]{%
  \begingroup
  \renewcommand{\thelem}{\ref{#1}}%
  \expandafter\expandafter\expandafter\lem%
...
\NewEnviron{restatablelemma}[1]{%
  ...
  \expandafter\lem\BODY\unskip\label{#1}\endlem%
}
\newcommand{\restatedefinition}[1]{%
  \begingroup
  \renewcommand{\thedefinition}{\ref{#1}}%
  \expandafter\expandafter\expandafter\defi%
...
\NewEnviron{restatabledefinition}[1]{%
  ...
  \expandafter\defi\BODY\unskip\label{#1}\enddefi%
}
...
%\declaretheorem[style=example,qed=$\triangle$]{example}
