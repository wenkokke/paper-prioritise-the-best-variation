...
\begin{restatable}{theorem}{thmpgvsubjectelaboration}[Subject Elaboration]
  If $\tseq[\cs{o}]{\ty{\Gamma}}{M}{T}$, $\tm{M}\elabarrow\tm{N}$, and $\ty{T}\elabarrow\ty{U}$,
  then $\tseq[\cs{o}]{\ty{\Gamma}}{N}{U}$.
\end{restatable}

\begin{restatable}{lemma}{lempgvvaluedone}
  \label{lem:value-done}
