...
\todo{You might want to clarify (repeat) that external choice can be modeled by sum type communication only because the language uses linear channels. (We also might want to emphasise that the modelling of choice in GV by~\cite{lindleymorris15} is unsound.)}
