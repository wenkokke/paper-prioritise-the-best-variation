...
\begin{example}[Cyclic Structure]
  \[\tm{%
    \begin{array}{l}
      ...
      \spawn\left(%
      \begin{array}{l}
        {\andthen{\recv\;{x'}}{\send\;{\pair{\unit}{y}}}};
        \\
        {\andthen{\wait\;{x'}}{\close\;{y}}}
      \end{array}%
      \right);
      \\
      \underline{\andthen{\send\;{\pair{\unit}{x}}}{\recv\;{y'}}};
      \\
...
\begin{example}[Deadlock]
  \[\tm{%
    \begin{array}{l}
      ...
      \right);
      \\
      \underline{\andthen{\recv\;{y'}}{\send\;{\pair{\unit}{x}}}}
      \\
      {\andthen{\close\;{x}}{\wait\;{y'}}}
    \end{array}
  }\]
...
\end{mathpar}
The approximation of the lower bound is not entirely accurate, \eg, $\tm{\lambda{x}.\send\;\pair{x}{y}}$ has lower bound $\ptop$, not $\cs{o}$, but as we only ever under-approximate, it is safe.
