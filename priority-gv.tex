...
We define the type of pure functions, \ie functions which perform no communication, and types for internal and external choice. Furthermore, we define term constructs for sequential composition, let-binding, various pattern matching lambda abstractions, fork, which combines channel creation and thread spawning in one construct, and internal and external choice.
\[
\begin{array}{lcl}
  \ty{\tylolli{T}{U}}
