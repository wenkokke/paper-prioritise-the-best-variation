...
\begin{compacttheorems}
  ...
  \end{corollary}
\end{compacttheorems}
\Cref{thm:pgv-closed-progress-confs} and \cref{cor:pgv-closed-progress} state that a configuration in PGV will complete all its communication actions, thus satisfying deadlock freedom or reduce to a term which is a value in PGV and contains no channel endpoints.
\end{document}
