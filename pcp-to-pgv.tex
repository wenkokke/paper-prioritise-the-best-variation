...
\begin{proof}
  ...
  \begin{case*}[\LabTirName{E-Lnk}]
    \begin{mathpar}
      \begin{tikzcd}[cramped, column sep=small]
        \pcp{\tm{\res{x}{y}{(\ppar{\link{w}{x}}{P})}}}
        \arrow[r, "\pcp{\red}"]
        &
        \pcp{\tm{\subst{P}{w}{x}}}
      \end{tikzcd}
    \end{mathpar}
  \end{case*}
  \begin{case*}[\LabTirName{E-Snd}]
    \[\pcp{%
      \tm{\res{x}{y}{(\ppar{\send{x}{z}{P}}{\recv{x}{w}{Q}})}}
      \red
      \tm{\res{x}{y}{\res{z}{w}{(\ppar{P}{Q})}}}
    }\]
    \admit
  \end{case*}
  \begin{case*}[\LabTirName{E-End}]
    \[\pcp{%
      \tm{\res{x}{y}{(\ppar{\close{x}{P}}{\wait{y}{Q}})}}
      \red
      \tm{\ppar{P}{Q}}
    }\]
    \admit
  \end{case*}
  \begin{case*}[\LabTirName{E-Sel\textsubscript{1}}]
    \[\pcp{%
    ...
    \admit
  \end{case*}
  \begin{case*}[\LabTirName{E-Sel\textsubscript{2}}]
    \[\pcp{%
