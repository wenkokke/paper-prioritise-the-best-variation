...
\begin{proof}
  See~\cite{dardha2018}. \todo{SR in \cite{dardha2018} uses commuting conversions. I guess here the result follows as we are simply considering a subset of reductions?}
\end{proof}
...
\begin{definition}[Actions]
  ...
  \todo{Can't we simplify this def and say that every process is an action except restriction, par and zero.}
\end{definition}
