...
The translations $\tm{\cpgvC{\cdot}}$ and $\tm{\cpgvM{\cdot}}$ preserve typing along $\ty{\cpgvT{\cdot}}$:\simon{This reads weirdly---what's the intuition?}
