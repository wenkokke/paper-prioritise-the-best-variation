...
PCP decomposes cut into \LabTirName{T-Res} and \LabTirName{T-Par}, and guarantees deadlock freedom using priority constraints, \eg, in \LabTirName{T-Send}. The full typing rules and operational semantics are available in \cref{fig:pcp-operational-semantics,fig:pcp-typing} and in \cite{dardhagay18}:
\begin{mathpar}
  \small
  \inferrule*[lab=T-Res]{
