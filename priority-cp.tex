...
Reduction in our version of PCP satisfies progress:
...
\end{restatabletheorem}
\begin{proof}
    Our proof follows the reasoning by Kobayashi~\cite{kobayashi06} used in the proof of deadlock freedom for closed processes (Theorem 2). The details can be found in~\Cref{prf:thm-pcp-closed-progress}.
\end{proof}
...
\begin{compacttheorems}
  ...
  \end{restatablelemma}
  \begin{proof}
    By induction on the structure of $\pcp{\tm{P}}$. Details in \cref{prf:lem-pcp-to-pgv-cpgvM-to-cpgvC}.
  \end{proof}
