...
\DeclarePairedDelimiter{\cpgvT}{\llbracket}{\rrbracket}
\DeclarePairedDelimiter{\cpgvM}{\llparenthesis}{\rrparenthesis}
\DeclarePairedDelimiter{\cpgvC}{\llbracket}{\rrbracket}
