...
%
Session type systems guarantee communication safety and session fidelity, but cannot rule out deadlocks arising from the interleaving of different sessions.
