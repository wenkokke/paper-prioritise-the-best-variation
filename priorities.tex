...
\section{Priority GV}
{
  ...
  \subsection*{Typing Derivations for Syntactic Sugar}
  The typing derivations for the typing rules for syntactic sugar defined in~\cref{sec:pgv-syntax-sugar} are shown in~\cref{fig:pgv-typing-sugar,fig:pgv-typing-sugar-fork,fig:pgv-typing-sugar-select-inl,fig:pgv-typing-sugar-select-inr,fig:pgv-typing-sugar-offer,fig:pgv-typing-sugar-offer-absurd}.
  \input{prf/lem-pgv-subject-elaboration}
  ...
  \restatelemma{lempgvopenprogressterms}

  \restatetheorem{thmpgvopenprogressconfs}
}
\section{Priority CP to Priority GV}
{
  ...
  \restatelemma{lempcptopgvcpgvMcpgvCcompleteness}
  \input{prf/lem-pcp-to-pgv-cpgvM-cpgvC-completeness}

  \restatetheorem{thmpcptopgvoconfsoperationalcorrespondencesoundness}

  \restatetheorem{thmpcptopgvoconfsoperationalcorrespondencecompleteness}
}
