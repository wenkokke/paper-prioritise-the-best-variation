...
\newenvironment{case*}[1]{\flushleft\textbf{Case} (#1).}{\endflushleft}
\newenvironment{subcase*}[1]{\flushleft\textbf{Subcase} (#1).}{\endflushleft}
\newenvironment{subsubcase*}[1]{\flushleft\textbf{Subsubcase} (#1).}{\endflushleft}
...
\DeclarePairedDelimiter{\cpgv}{\llbracket}{\rrbracket}
\newcommand{\cpgvc}[1]{\ensuremath{\cpgv{#1}^{\conf{C}}}}
\newcommand{\cpgvarrow}[0]{\xRightarrow{\;\raisebox{2pt}{\ensuremath{{\cpgv{\cdot}}}}\;}}
...
\namespace*{pgv}{
  ...
  \providecommand{\cred}[0]{\ensuremath{\longrightarrow}}
}{}
\newcommand{\pgv}[1]{\namespace*{pgv}{}{#1}}
...
\section{Priority GV}
{
  ...
  \thmpgvsubjectreductionterms
  \input{prf/thm-pgv-subject-reduction-terms}

  \thmpgvsubjectcongruence
  \input{prf/thm-pgv-subject-congruence}

  \thmpgvsubjectreductionconfs
  \input{prf/thm-pgv-subject-reduction-confs}
}
\section{Priority CP to Priority GV}
{
  \lempcptopgvtermspreservation
  \input{prf/lem-pcp-to-pgv-terms-preservation}

  \thmpcptopgvconfspreservation
